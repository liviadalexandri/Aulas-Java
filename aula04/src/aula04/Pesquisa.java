...
Scanner leia = new Scanner (System.in);
		...
		int idade, esporte, futebol = 0, voleibolM18 = 0, basqueteMn18 = 0, outros = 0, totalRespostas = 0;
		long somaIdades = 0;
		...
		while (continua.equalsIgnoreCase("S")) {
			...
			do {			
			System.out.println("\nInforme o seu esporte favorito(1- Futebol / 2- Vôlei / 3- Basquetebol / 4- Outros): ");
